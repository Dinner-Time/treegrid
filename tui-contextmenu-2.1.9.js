...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    else if (typeof exports === 'object') exports['ContextMenu'] = factory();
    else
        (root['tui'] = root['tui'] || {}),
            (root['tui']['ContextMenu'] = factory());
})(window, function () {
    return /******/ (function (modules) {
        ...
        /******/ [
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var _contextmenu = _interopRequireDefault(
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var _preventDefault = _interopRequireDefault(
                ...
                var _floatingLayer = _interopRequireDefault(
                    ...
                    (function () {
                        ...
                        _proto._hideContextMenu = function _hideContextMenu() {
                            ...
                            (0, _forEachArray['default'])(
                                layer.container.querySelectorAll(
                            ...
                            (0, _forEachArray['default'])(
                                layer.container.querySelectorAll(
                                    '.tui-contextmenu-selected'
                                ),
                                function (highlightMenu) {
                                    return (0, _removeClass['default'])(
                                        highlightMenu,
                                        'tui-contextmenu-selected'
                                    );
                                }
                        ...
                        _proto._onMouseDown = function _onMouseDown(
                            mouseDownEvent
                        ) {
                            var target =
                                mouseDownEvent.target ||
                                mouseDownEvent.srcElement;
                        ...
                        _proto._onMouseClick = function _onMouseClick(
                            clickEvent
                        ) {
                            var _this = this;
                            ...
                            var command = (0, _getData['default'])(
                                target,
                                'command'
                            );
                            var container = (0, _closest['default'])(
                                target,
                                '.floating-layer'
                            );
                            var isMenuButton = (0, _hasClass['default'])(
                                target,
                                'tui-contextmenu-button'
                            );
                            var isSeparator = (0, _hasClass['default'])(
                                target,
                                'tui-contextmenu-separator'
                            );
                            var hasSubmenu = (0, _hasClass['default'])(
                                target,
                                'tui-contextmenu-has-submenu'
                            );
                            var isDisableButton = (0, _hasClass['default'])(
                                target,
                                'tui-contextmenu-disable'
                            );
                        ...
                        _proto._showWithoutOverflow =
                            function _showWithoutOverflow(element) {
                                var strategy =
                                    arguments.length > 1 &&
                                    arguments[1] !== undefined
                                        ? arguments[1]
                                        : {
                                              rightOverflow:
                                                  function rightOverflow() {},
                                              bottomOverflow:
                                                  function bottomOverflow() {},
                                          };
                                var initialStyle =
                                    arguments.length > 2 &&
                        ...
                        _proto._showRootMenu = function _showRootMenu(
                            left,
                            top
                        ) {
                            var layer = this.activeLayer;
                            ...
                            var rootMenuElement = layer.container.querySelector(
                                '.tui-contextmenu-root'
                            );
                            layer.setBound({
                                left: left,
                            ...
                            this._showWithoutOverflow(rootMenuElement, {
                                ...
                                bottomOverflow: function bottomOverflow(
                                    ...
                                    (0, _css['default'])(
                                        el,
                                        'marginTop',
                                        ''.concat(viewportHeight - bottom, 'px')
                                    );
                                },
                            });
                        };
                        ...
                        _proto._refreshMenuDisplay =
                            function _refreshMenuDisplay(layerOnCursor) {
                                var _this2 = this;

                                var container = this.activeLayer.container;
                                var allSubmenus = container.querySelectorAll(
                                    '.tui-contextmenu-submenu'
                                );
                                var layersUntilRoot = [];
                        ...
                        _proto._onMouseMove = function _onMouseMove(
                            ...
                            var target =
                                ...
                                mouseMoveEvent.srcElement;
                            var activeLayer = this.activeLayer;

                            if (this.prevElement) {
                                (0, _removeClass['default'])(
                                    this.prevElement,
                                    'tui-contextmenu-selected'
                                );
                            }
                            ...
                            if (
                                ...
                                layerOnCursor = target.parentNode.querySelector(
                                    '.tui-contextmenu-submenu'
                                );
                            } else {
                                layerOnCursor = (0, _closest['default'])(
                                    target,
                                    '.tui-contextmenu-submenu'
                                );
                            }
                        ...
                        _proto._highlightMenuHasSubmenu =
                            function _highlightMenuHasSubmenu(layer) {
                                if (!layer) {
                                    this.prevElement = null;
                                    return;
                                }
                                ...
                                var selectedMenu =
                                    layer.parentNode.querySelector(
                                        '.tui-contextmenu-button'
                                    );
                                (0, _addClass['default'])(
                                    selectedMenu,
                        ...
                        _proto._onContextMenu = function _onContextMenu(
                            clickEvent
                        ) {
                            var _this3 = this;
                            ...
                            var _getMousePosition = (0, _util.getMousePosition)(
                                    clickEvent,
                                    this.activeLayer.container
                                ),
                                left = _getMousePosition.left,
                                top = _getMousePosition.top;

                            var debouncedMouseMove = (0, _debounce['default'])(
                            ...
                            this.cloneMouseMoveEvent = function (
                                mouseMoveEvent
                            ) {
                        ...
                        _proto.register = function register(
                            ...
                            var layer = new _floatingLayer['default'](
                                this.container
                            );
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var _removeElement = _interopRequireDefault(
                ...
                var FloatingLayer =
                    ...
                    (function () {
                        ...
                        _proto.initializeContainer =
                            function initializeContainer(manager) {
                        ...
                        _proto.setBound = function setBound(bound) {
                            var newBound = {};
                            (0, _forEachOwnProperties['default'])(
                                bound,
                                function (value, prop) {
                                    if ((0, _isExisty['default'])(value)) {
                                        newBound[prop] = (0,
                                        _isNumber['default'])(value)
                                            ? ''.concat(value, 'px')
                                            : value;
                                    }
                                }
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var _sendHostname = _interopRequireDefault(
